...
!real,dimension(n1) :: thp_m2d,rtp_m2d,pc_m2d
real,allocatable, dimension(:) :: thp_m2d,rtp_m2d,pc_m2d
integer ncount 
...
jr=int(n3/2)
topref=topt(ir,jr)
print*,'Reference sounding is at=',ir,jr,topref
endif
!------
...
if(ref_mean == 1 ) then 
   allocate(thp_m2d(n1),rtp_m2d(n1),pc_m2d(n1))
  thp_m2d=0.;rtp_m2d=0.; pc_m2d=0.
...
if(ref_mean == 1 ) then 
  ...
  call htint2(n1,thp_m2d,vctr2,n1,vctr1,zt)
  call htint2(n1,rtp_m2d,vctr2,n1,rtref(1),zt)
...
if(ref_mean == 1 ) then 
   ...
   piref(1) =pc_m2d(1) + g * (vctr2(1) - zt(1))  &
                  / (.5 * (thref(1)  &
...
!--(DMK-CCATT-INI)----------------------------------------------------------------
!srf
if(ref_mean == 1 ) deallocate(thp_m2d,rtp_m2d,pc_m2d)
!--(DMK-CCATT-FIM)----------------------------------------------------------------
