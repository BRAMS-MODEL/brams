...
!     Chemical production terms.                                                
      ...
      chem(ijk,  9) = - w(ijk,  6) &
          ...
          - w(ijk, 37) &
          - w(ijk, 41)
      chem(ijk, 10) = - w(ijk, 51)
      chem(ijk, 11) = + w(ijk, 51)
      ...
      chem(ijk, 20) = + w(ijk,  4) &
          ...
          - w(ijk, 55) &
          - w(ijk, 56) &
          -  0.9991220000000000D+00 * w(ijk, 57) &
          - w(ijk, 58) &
          - w(ijk, 59) &
          - w(ijk, 60) &
          - w(ijk, 61) &
          ...
          -  0.5507500000000001D+00 * w(ijk, 66) &
          - w(ijk, 67) &
          - w(ijk, 68) &
          ...
          + w(ijk, 84)
      chem(ijk, 21) = +  0.6500000000000000D+00 * w(ijk,  6) &
          ...
          - w(ijk, 25) &
          + w(ijk, 26) &
          -  0.2000000000000000D+01 * w(ijk, 27) &
          ...
          - w(ijk,123) &
          + w(ijk,124)
      chem(ijk, 22) = - w(ijk, 55) &
          +  0.4300000000000000D-01 * w(ijk, 76)
      chem(ijk, 23) = - w(ijk, 56) &
          +  0.3196000000000000D-01 * w(ijk, 76)
      chem(ijk, 24) = - w(ijk, 57)
      chem(ijk, 25) = +  0.9186800000000001D+00 * w(ijk, 53) &
          - w(ijk, 58) &
          - w(ijk, 73) &
          - w(ijk, 76) &
      ...
      chem(ijk, 26) = - w(ijk, 53) &
          - w(ijk, 59) &
          - w(ijk, 74) &
          - w(ijk, 77)
      chem(ijk, 27) = - w(ijk, 60) &
          - w(ijk, 72) &
          +  0.1067000000000000D+00 * w(ijk, 80) &
          +  0.1066980000000000D+01 * w(ijk, 81) &
          + w(ijk, 82) &
          +  0.2000000000000000D-01 * w(ijk, 83) &
          + w(ijk, 84)
      chem(ijk, 28) = - w(ijk, 10) &
          - w(ijk, 11) &
          + w(ijk, 13) &
      ...
      chem(ijk, 30) = - w(ijk, 15) &
          +  0.8000000000000000D+00 * w(ijk, 17) &
      ...
      chem(ijk, 31) = - w(ijk, 16) &
          +  0.1325500000000000D+00 * w(ijk, 53) &
          - w(ijk, 54) &
          +  0.8350000000000000D-02 * w(ijk, 57) &
          -  0.8308100000000000D+00 * w(ijk, 64) &
          +  0.2186300000000000D+00 * w(ijk, 67) &
          -  0.8947000000000001D+00 * w(ijk, 71) &
      ...
      chem(ijk, 32) = - w(ijk, 17) &
          - w(ijk, 68) &
          +  0.6000000000000000D+00 * w(ijk, 75) &
          + w(ijk, 80) &
          ...
          +  0.2592800000000000D+00 * w(ijk,122)
      chem(ijk, 33) = -  0.7189300000000001D+00 * w(ijk, 67) &
          -  0.6000000000000000D+00 * w(ijk, 75) &
          -  0.7000000000000000D+00 * w(ijk, 79) &
          + w(ijk, 85) &
          - w(ijk, 86)
      chem(ijk, 34) = - w(ijk, 13) &
          - w(ijk, 65) &
          + w(ijk, 94)
      chem(ijk, 35) = - w(ijk, 14) &
          - w(ijk, 66) &
          +  0.1014900000000000D+00 * w(ijk, 78) &
      ...
      chem(ijk, 36) = +  0.8780000000000000D-02 * w(ijk, 57) &
      ...
      chem(ijk, 37) = +  0.8143000000000000D-01 * w(ijk, 76) &
          +  0.2059500000000000D+00 * w(ijk, 78) &
          +  0.1730700000000000D+00 * w(ijk, 99) &
      ...
      chem(ijk, 38) = + w(ijk, 12) &
          ...
          - w(ijk, 94) &
          -  0.2000000000000000D+01 * w(ijk,101) &
          -  0.9861000000000000D+00 * w(ijk,102) &
          - w(ijk,103) &
          - w(ijk,104) &
          - w(ijk,105) &
          -  0.4396900000000000D+00 * w(ijk,106) &
          - w(ijk,107) &
          ...
          - w(ijk,124) &
          + w(ijk,125)
      chem(ijk, 39) = + w(ijk, 15) &
          + w(ijk, 56) &
          +  0.8781099999999999D+00 * w(ijk, 57) &
          +  0.4034100000000000D+00 * w(ijk, 66) &
          + w(ijk, 68) &
          +  0.9815000000000000D-01 * w(ijk, 76) &
          -  0.9181300000000000D+00 * w(ijk, 88) &
          - w(ijk, 95) &
          -  0.9961500000000000D+00 * w(ijk,102) &
          -  0.9917200000000000D+00 * w(ijk,108) &
          -  0.9100600000000000D+00 * w(ijk,117)
      chem(ijk, 40) = +  0.1025290000000000D+01 * w(ijk, 58) &
          - w(ijk, 89) &
          - w(ijk, 96) &
          - w(ijk,103) &
          - w(ijk,109) &
          - w(ijk,118)
      chem(ijk, 41) = + w(ijk, 59) &
          - w(ijk, 90) &
          - w(ijk, 97) &
          - w(ijk,104) &
          - w(ijk,110) &
          - w(ijk,119)
      chem(ijk, 42) = +  0.2760000000000000D-02 * w(ijk, 60) &
          + w(ijk, 72) &
          - w(ijk, 80) &
          - w(ijk, 81)
      chem(ijk, 43) = +  0.9396800000000000D+00 * w(ijk, 60) &
          - w(ijk, 82) &
          - w(ijk, 83) &
          - w(ijk, 84)
      chem(ijk, 44) = +  0.9800000000000000D+00 * w(ijk, 83) &
          - w(ijk, 91) &
          - w(ijk, 98) &
          - w(ijk,105) &
          - w(ijk,111) &
          - w(ijk,120)
      chem(ijk, 45) = + w(ijk, 15) &
          ...
          - w(ijk, 85) &
          + w(ijk, 86) &
          -  0.9046800000000000D+00 * w(ijk, 92) &
          - w(ijk, 99) &
          -  0.9404600000000000D+00 * w(ijk,106) &
          - w(ijk,108) &
          - w(ijk,109) &
          - w(ijk,110) &
          - w(ijk,111) &
          -  0.1941790000000000D+01 * w(ijk,112) &
          - w(ijk,113) &
          -  0.9682500000000001D+00 * w(ijk,121) &
          - w(ijk,125)
      chem(ijk, 46) = +  0.9376800000000000D+00 * w(ijk, 73) &
          + w(ijk, 74) &
          - w(ijk, 93) &
          - w(ijk,100) &
          - w(ijk,107) &
          - w(ijk,113) &
          -  0.2000000000000000D+01 * w(ijk,114) &
          -  0.2000000000000000D+01 * w(ijk,115) &
          - w(ijk,122)
      chem(ijk, 47) = +  0.1500000000000000D+00 * w(ijk, 53) &
          +  0.1031800000000000D+00 * w(ijk, 60) &
          ...
          - w(ijk,124) &
          - w(ijk,125) &
          -  0.2000000000000000D+01 * w(ijk,126) &
          - w(ijk,127) &
          - w(ijk,128)
      END DO   
