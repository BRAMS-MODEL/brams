...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spAllocate.c,v 1.2 2011/01/28 14:00:33 rafaelm Exp $";
#endif
...
//printf("LFR: In spCreate: Complex=%d, Allocated Size=%d \n",Complex,Matrix->AllocatedSize);
    Matrix->ExtSize = Size;
...
/* Allocate block of MatrixElements for elements. */
    ...
    RecordAllocation( Matrix, (char *)pElement );
    if (Matrix->Error == spNO_MEMORY) return -1;
