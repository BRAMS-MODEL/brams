...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spBuild.c,v 1.2 2011/01/28 14:00:33 rafaelm Exp $";
#endif
...
//printf("LFR -> row,col: %d %d %d %d\n",Row,Col,IS_SPARSE( Matrix ),Matrix->Elements);
void  Translate();
//printf("LFR: In spGetElement: Allocated Size=%d \n",Matrix->AllocatedSize);


//printf("LFR: In spGetElement: %d\n",(int)(&Matrix->LastFillinListNode)-(int)(&Matrix->AbsThreshold));
