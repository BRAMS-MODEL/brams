...
static char RCSid[] =
    "$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spOutput.c,v 1.1.1.1 2009/01/09 18:56:32 rafaelm Exp $";
#endif
...
//double LARGEST_REAL=1.79769313486231e+308; //LFR
