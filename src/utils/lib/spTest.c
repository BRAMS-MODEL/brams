...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spTest.c,v 1.1.1.1 2009/01/09 18:56:32 rafaelm Exp $";
#endif
...
extern double  Time();
extern char *sbrk();
//double 	SMALLEST_REAL=2.22507385850721e-308; //LFR
