...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spFortran.c,v 1.1.1.1 2009/01/09 18:56:32 rafaelm Exp $";
#endif
...
{
/* Begin `sfGetElement'. */
//    printf("LFR - > In sfGetElement: %d %d %d \n",*Matrix,*Row,*Col);
