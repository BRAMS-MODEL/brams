...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spUtils.c,v 1.2 2011/01/28 14:00:33 rafaelm Exp $";
#endif
...
//double 	MACHINE_RESOLUTION=6.93889e-18; //LFR
