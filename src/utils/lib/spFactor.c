...
static char RCSid[] =
    "@(#)$Header: /repositorios/cvs/ccatt-brams/CCATT-BRAMS-4.3.2/src/utils/lib/spFactor.c,v 1.2 2011/01/28 14:00:33 rafaelm Exp $";
#endif
...
double fProduct;
//int LARGEST_SHORT_INTEGER=32766; //LFR
//long LARGEST_LONG_INTEGER=2147483646; //LFR
