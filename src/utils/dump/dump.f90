  ...
  integer function dump2DLogical(tty,color,header,version,dumpType,message &
    ...
    integer function bramsHeader(rev) 
        ...
        !Code
         ...
         write (*,fmt='(A)') '                            Rev. '//rev
         write (*,fmt='(A)') ''
         write (*,fmt='(A)') 'This  model  version  is  under the  Attribution-ShareAlike  4.0  '
         write (*,fmt='(A)') 'International (CC BY-SA 4.0) license. See in site above: '
         write (*,fmt='(A)') 'https://creativecommons.org/licenses/by-sa/4.0/'
         write (*,fmt='(A)') '------------------------------------------------------------------' 
         write (*,fmt='(A)') ''
         write (*,fmt='(A)') ''
